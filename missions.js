...
const MISSION_POOL = {
  ...
  use_hero: [
    ...
    { name: "Arma X Global", desc: "Usa a Wolverine en {target} batallas", targetRange: [100, 500], icon: "a/fs/2fk0011.png", heroName: "Wolverine", heroSequence: 29 },
    { name: "Furia Esmeralda", desc: "Usa a Hulk en {target} batallas", targetRange: [100, 500], icon: "a/fs/wd0011.png", heroName: "Hulk", heroSequence: 11 },
    { name: "Trepamuros Global", desc: "Usa a Spider-Man en {target} batallas", targetRange: [100, 500], icon: "a/fs/6d0014.png", heroName: "Spider-Man", heroSequence: 23 },
    { name: "Tormenta Global", desc: "Usa a Storm en {target} batallas", targetRange: [100, 500], icon: "a/fs/340011.png", heroName: "Storm", heroSequence: 25 },
    { name: "Rayo Optico", desc: "Usa a Cyclops en {target} batallas", targetRange: [100, 500], icon: "a/fs/24o0011.png", heroName: "Cyclops", heroSequence: 8 },
    { name: "Viuda Negra Global", desc: "Usa a Black Widow en {target} batallas", targetRange: [100, 500], icon: "a/fs/3mm0012.png", heroName: "Black Widow", heroSequence: 3 },
  ],
  apply_status: [
